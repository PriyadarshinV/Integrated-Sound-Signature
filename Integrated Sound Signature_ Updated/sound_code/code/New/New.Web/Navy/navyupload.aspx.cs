...
namespace New.Web
{
    public partial class navyupload : System.Web.UI.Page
    {
        ...
        protected void btnsubmit_Click1(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into uploadfile values('"+lbl_fileid.Text+"','"+txt_fname.Text+"',@files,'Navy')",con);
