...
{
    public partial class navyplay : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlDataAdapter ad = new SqlDataAdapter("select * from reg where uid='" + Session["uid"] + "' and field='Navy'", con);
        ...
        {
            Response.Redirect("~/Navy/navydownload.aspx");
        } 
