...
{
    public partial class defenceplay : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlDataAdapter ad = new SqlDataAdapter("select * from reg where uid='" + Session["uid"] + "' and field='Defence'", con);
        ...
        {
            Response.Redirect("~/Defence/defencedownload.aspx");
        }
