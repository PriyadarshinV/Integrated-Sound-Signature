...
namespace New.Web.Defence
{
    public partial class deflogin : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            SqlDataAdapter adp = new SqlDataAdapter("select uid,name,x1,y1,time,x2,y2,x3,y3,x4,y4,x5,y5,email from reg where name='" + TextBox1.Text + "' and field='Defence'", con);
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    Response.Redirect("~/Defence/defenceupload.aspx");
                }
