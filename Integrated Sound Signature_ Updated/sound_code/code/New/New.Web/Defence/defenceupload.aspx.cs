...
namespace New.Web
{
    public partial class defenceupload : System.Web.UI.Page
    {
        ...
        protected void btnsubmit_Click1(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into uploadfile values('" + lbl_fileid.Text + "','" + txt_fname.Text + "',@files,'Defence')", con);
        ...
        {
            con.Open();
            SqlDataAdapter adp = new SqlDataAdapter("select * from uploadfile where name='Defence'", con);
