...
namespace New.Web
{
     public partial class Firstpage : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Session["x1"] = Label4.Text;
            Session["y1"] = Label5.Text;
            Session["time"] = HtmlText1.Text;
            Session["x2"] = Label7.Text;
            Session["y2"] = Label8.Text;
            Session["x3"] = Label9.Text;
            Session["y3"] = Label10.Text;
            Session["x4"] = Label11.Text;
            Session["y4"] = Label12.Text;
            Session["x5"] = Label13.Text;
            Session["y5"] = Label14.Text;
            con.Open();
            SqlDataAdapter adp = new SqlDataAdapter("select name,x1,y1,time,x2,y2,x3,y3,x4,y4,x5,y5,email from reg where name='" + TextBox1.Text + "'", con);
