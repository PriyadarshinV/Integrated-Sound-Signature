<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="airplay.aspx.cs" Inherits="New.Web.Airforce.airplay" %>
        ...
        <tr>
            ...
            <td class="style31">
                ...
                <asp:Silverlight ID="Xaml1" runat="server" Height="183px" 
                    MinimumVersion="2.0.31005.0" Source="~/ClientBin/New.xap" Width="200px" /></asp:Silverlight>
            </td>
            <td class="style32">
                </td>
        </tr>
