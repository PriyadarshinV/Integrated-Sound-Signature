...
namespace New.Web
{
    public partial class airforceupload : System.Web.UI.Page
    {
        ...
        protected void btnsubmit_Click1(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into uploadfile values('" + lbl_fileid.Text + "','" + txt_fname.Text + "',@files,'Airforce')", con);
        ...
        {
            con.Open();
            SqlDataAdapter adp = new SqlDataAdapter("select * from uploadfile where name='Airforce'", con);
